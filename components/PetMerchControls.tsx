...
import { PetMerchParams } from '../types';
import { PET_MERCH_PRESETS } from '../constants/petMerchOptions';

interface PetMerchControlsProps {
    petMerchParams: PetMerchParams;
    onChange: (params: PetMerchParams) => void;
}

export const PetMerchControls: React.FC<PetMerchControlsProps> = ({
    petMerchParams,
    onChange
}) => {
        ...
        <div className="space-y-6 animate-fadeIn">
            ...
            <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                    {PET_MERCH_PRESETS.map((preset) => {
                        const isSelected = petMerchParams.selectedPreset === preset.id;
                        return (
                            <button
                                key={preset.id}
            ...
            <div>
                ...
                {showCustomPrompt && (
                    <div className="mt-3 animate-fadeIn">
                        ...
                        <textarea
                            value={petMerchParams.customPrompt || ''}
            ...
            <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-3 text-xs text-purple-200">
                <div className="flex items-start">
                    ...
                    <div>
                        <strong>萌宠与周边模式说明：</strong>
                        <br />
                        • 将您的宠物或人物照片转化为有趣的周边商品风格
                        <br />
                        • 包含：日式印章、可爱贴纸、扭蛋玩具、定制包装等
                        <br />
                        • 建议上传清晰的主体照片，背景不要太杂乱
                    </div>
                </div>
